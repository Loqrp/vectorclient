...
local getcustomassets = {
	['vectorclient/assets/rise/slice.png'] = 'rbxasset://risesix/slice.png',
	['vectorclient/assets/rise/blur.png'] = 'rbxasset://risesix/blur.png',
...
local function writeFont()
	...
	writefile('vectorclient/assets/rise/risefont.json', httpService:JSONEncode({
		name = 'ProductSans',
		faces = {
			{style = 'normal', assetId = getcustomasset('vectorclient/assets/rise/SF-Pro-Rounded-Light.otf'), name = 'Light', weight = 300},
			{style = 'normal', assetId = getcustomasset('vectorclient/assets/rise/SF-Pro-Rounded-Regular.otf'), name = 'Regular', weight = 400},
			{style = 'normal', assetId = getcustomasset('vectorclient/assets/rise/SF-Pro-Rounded-Medium.otf'), name = 'Medium', weight = 500},
			{style = 'normal', assetId = getcustomasset('vectorclient/assets/rise/Icon-1.ttf'), name = 'Icon1', weight = 600},
			{style = 'normal', assetId = getcustomasset('vectorclient/assets/rise/Icon-3.ttf'), name = 'Icon3', weight = 800}
		}
	}))
	return getcustomasset('vectorclient/assets/rise/risefont.json')
end
	...
	Function = function(val, mouse)
		if mouse then
			...
			if shared.VapeDeveloper then
				...
				loadstring(game:HttpGet('https://raw.githubusercontent.com/7GrandDadPGN/VapeV4ForRoblox/'..readfile('vectorclient/profiles/commit.txt')..'/loader.lua', true))()
			end
		end
	end
})
		...
		for i, v in mainapi.Modules do
			if v.Enabled or table.find(found, i) then
				...
				if interfacebar.Enabled then
					...
					holderline.Image = getcustomasset('vectorclient/assets/rise/slice.png')
